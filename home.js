...
const divs = document.querySelectorAll(".dark-menu");
...
let imageWrappers = [...document.querySelectorAll("[wGL=wrapper]")];

imageWrappers.map((imgWrapper) => {
  let imageURL1 = imgWrapper.querySelector("[wGL=image1]").src;
  let imageURL2 = imgWrapper.querySelector("[wGL=image2]").src;
  var myAnimation = new hoverEffect({
    ...
    image2: imageURL2,
    displacementImage:
      "https://uploads-ssl.webflow.com/63f7b37a54bcad3b210ff543/64258fffc527ef3367fd0544_5bc9486cdc837c82711dfb73_displacement-4%20(1).png"
  });
});
...
window.addEventListener("load", () => {
  ...
  let callback = (entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        ...
        let letters = [...section.querySelectorAll("[letters-slide-down]")];
        letters.map((letter) => {
  ...
  document.querySelectorAll(".scrollify").forEach((section) => {
